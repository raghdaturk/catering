...
! function(a) { "use strict"; "function" == typeof define && define.amd ? define(["jquery"], a) : "undefined" != typeof exports ? module.exports = a(require("jquery")) : a(jQuery) }(function(a) {
    ...
    b = function() {
        function c(c, d) {
            var f, g, h, e = this;
            if (e.defaults = { accessibility: !0, adaptiveHeight: !1, appendArrows: a(c), appendDots: a(c), arrows: !0, asNavFor: null, prevArrow: '<button type="button" data-role="none" class="slick-prev"><svg width="23" height="10" viewBox="0 0 23 10"   xmlns="http://www.w3.org/2000/svg"><path  fill-rule="evenodd" clip-rule="evenodd" d="M5.56798 9.71381C5.41223 9.77732 5.24349 9.75192 5.1137 9.6503L0.129612 5.20448C0.0517356 5.12826 -0.000181198 5.02665 -0.000181198 4.91232C-0.000181198 4.798 0.0517356 4.68368 0.129612 4.60747L5.1137 0.0981378C5.24349 -0.0034809 5.41223 -0.0288856 5.56798 0.0346261C5.71075 0.0981378 5.81459 0.237864 5.81459 0.402994V3.24832L22.0129 3.24832C22.2465 3.24832 22.4282 3.42615 22.4282 3.65479V6.09364C22.4282 6.32228 22.2465 6.50012 22.0129 6.50012L5.81459 6.50012V9.34544C5.81459 9.51057 5.72373 9.6503 5.56798 9.71381Z"/></svg></button>', nextArrow: '<button type="button" data-role="none" class="slick-next"><svg width="23" height="10" viewBox="0 0 23 10" xmlns="http://www.w3.org/2000/svg"><path   fill-rule="evenodd" clip-rule="evenodd" d="M17.432 0.286191C17.5878 0.222679 17.7565 0.248084 17.8863 0.349702L22.8704 4.79552C22.9483 4.87174 23.0002 4.97335 23.0002 5.08768C23.0002 5.202 22.9483 5.31632 22.8704 5.39253L17.8863 9.90186C17.7565 10.0035 17.5878 10.0289 17.432 9.96537C17.2892 9.90186 17.1854 9.76214 17.1854 9.59701V6.75168L0.987118 6.75168C0.753489 6.75168 0.571777 6.57385 0.571777 6.34521L0.571777 3.90636C0.571777 3.67772 0.753489 3.49988 0.987118 3.49988L17.1854 3.49988V0.654558C17.1854 0.489429 17.2763 0.349703 17.432 0.286191Z"></svg></button>', autoplay: !1, autoplaySpeed: 3e3, centerMode: !1, centerPadding: "50px", cssEase: "ease", customPaging: function(a, b) { return '<button type="button" data-role="none">' + (b + 1) + "</button>" }, dots: !1, dotsClass: "slick-dots", draggable: !0, easing: "linear", edgeFriction: .35, fade: !1, focusOnSelect: !1, infinite: !0, initialSlide: 0, lazyLoad: "ondemand", mobileFirst: !1, pauseOnHover: !0, pauseOnDotsHover: !1, respondTo: "window", responsive: null, rtl: !1, slide: "", slidesToShow: 1, slidesToScroll: 1, speed: 500, swipe: !0, swipeToSlide: !1, touchMove: !0, touchThreshold: 5, useCSS: !0, variableWidth: !1, vertical: !1, waitForAnimate: !0 }, e.initials = { animating: !1, dragging: !1, autoPlayTimer: null, currentDirection: 0, currentLeft: null, currentSlide: 0, direction: 1, $dots: null, listWidth: null, listHeight: null, loadIndex: 0, $nextArrow: null, $prevArrow: null, slideCount: null, slideWidth: null, $slideTrack: null, $slides: null, sliding: !1, slideOffset: 0, swipeLeft: null, $list: null, touchObject: {}, transformsEnabled: !1 }, a.extend(e, e.initials), e.activeBreakpoint = null, e.animType = null, e.animProp = null, e.breakpoints = [], e.breakpointSettings = [], e.cssTransitions = !1, e.hidden = "hidden", e.paused = !1, e.positionProp = null, e.respondTo = null, e.shouldClick = !0, e.$slider = a(c), e.$slidesCache = null, e.transformType = null, e.transitionType = null, e.visibilityChange = "visibilitychange", e.windowWidth = 0, e.windowTimer = null, f = a(c).data("slick") || {}, e.options = a.extend({}, e.defaults, f, d), e.currentSlide = e.options.initialSlide, e.originalSettings = e.options, g = e.options.responsive || null, g && g.length > -1) {
